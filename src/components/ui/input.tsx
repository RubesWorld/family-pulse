    ...
    return (
      <input
        ...
        className={cn(
          ...
          "focus-visible:border-coral focus-visible:outline-none focus-visible:shadow-[0_0_0_4px_rgb(var(--coral)/0.22),0_6px_22px_-8px_rgb(var(--coral)/calc(0.9*var(--glow)))]",
